...
FST::FST typeRIGHTBRACKET("", 2,
	FST::NODE(1, FST::RELATION(']', 1)),
	FST::NODE()
);
FST::FST typeLEFTTBRACKET("", 2,
	FST::NODE(1, FST::RELATION('[', 1)),
	FST::NODE()
);
...
FST::FST typeCheckEquals("", 3,
	FST::NODE(1, FST::RELATION('=', 1)),
	FST::NODE(1, FST::RELATION('=', 2)),
	FST::NODE());

FST::FST typeCheckUnequals("", 3,
	FST::NODE(1, FST::RELATION('!', 1)),
	FST::NODE(1, FST::RELATION('=', 2)),
	FST::NODE());
